...
function exibir_distribuidor() {
    ...
    id = 1;
        url = "http://desenv.queromarita.com.br/bg_loja__carregar_dados_dist.php";
        parametros = {
            id: id
        }
...
function exibir_detalhes() {
	...
	if (id !== "") {
        ...
        url = "http://desenv.queromarita.com.br/bg_produto_detalhe__detalhar.php";
        parametros = {
            id: id
        };
        requisicaoHTTP("GET",url,parametros,true,"produto_detalhe__detalhar");
...
function comprar(){
	...
	if (id !== "") {
		var url="http://desenv.queromarita.com.br/bg_produto_detalhe__comprar.php";
        var parametros ={
            id: id,
            qtde: qtde
        };
