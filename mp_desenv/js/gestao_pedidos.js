...
function carregar_menu(){
    var url="https://desenv.queromarita.com.br/bg_menu.php";
    var parametros = {
        fn: "le_menu"
    };
...
function carregar_rodape(){
    var url="https://desenv.queromarita.com.br/bg_footer.php";
    var parametros = {
        fn: "le_rodape"
    };
...
function verificar_sacola(){
    var url="https://desenv.queromarita.com.br/bg_sacola__carregar_sacola.php";
    var parametros = {
        fn: "outros"
    };
            ...
            case 'verificar_carrinho':
                switch(jsonData[i].opt){
                    case "direcionar_sacola":
                        window.location.replace('https://desenv.queromarita.com.br/sacola.html');
                    break;
                }
            break;
            case 'menu':
