...
function busca_dados_cli(){
	var url="http://desenv.queromarita.com.br/bg_pagamento.php";
    var parametros = {
        fn: "resgata_cliente",
    };
...
function busca_cep(cep){
	var url="http://desenv.queromarita.com.br/bg_busca_cep.php";
    var parametros = {
        fn: "busca_cep",
        cep: cep,
    };
...
function salva_customer(){
    var url="http://desenv.queromarita.com.br/bg_customers.php";
    var parametros = {
        fn: "salva_customer",
...
function contratar_assinatura(id_assinatura){
    var url="http://desenv.queromarita.com.br/bg_assinatura.php";
    var parametros = {
