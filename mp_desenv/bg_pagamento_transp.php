    ...
    function criar_pedido_pgto(){
        ...
        if(mysqli_num_rows($query)>0){
            ...
            $preference_data["back_urls"] = array(
                "success" => "http://desenv.queromarita.com.br/pedidos.html",//Approved payment URL
                "pending" => "http://desenv.queromarita.com.br/pedidos.html",//Pending payment URL 
                "failure" => "http://desenv.queromarita.com.br/pedidos.html"//Canceled payment URL 
            );
            $preference_data["notification_url"] = "http://desenv.queromarita..com.br/bg_answer_mercpago.php";
            $preference_data["marketplace"] = "http://desenv.queromarita.com.br";
            ...
            for($i=0;$i<mysqli_num_rows($query);$i++){
                ...
                $item = array(
                    ...
                    "category_id"=> "fashion",
                    "picture_url"=> "http://desenv.queromarita.com.br/" . $row[3],
