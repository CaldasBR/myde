<?php
                    ...
                    if(mysqli_num_rows($consulta)>0){
                        for($i=0;$i<mysqli_num_rows($consulta);$i++){
                            ...
                            if($row[0] >= 1){			
                                ...
                                $exec = shell_exec("cp /var/www/mp_desenv/media/imagens/default.jpg /var/www/mp_desenv/media/upload/user_".md5($row[0].$row[1]).".jpg");
    ...
    function validaemail($mail,$passwd){
