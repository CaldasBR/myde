<?php
	...
	require_once "/var/www/mp/bg_conexao_bd.php";

	function onLogin(){
		// Include detect.
		require_once '/var/www/mp/bg_biblioteca_detect.php';
		...
		if(isset($_SESSION['user_id'])){
            ...
            $consulta=mysqli_query($GLOBALS['con'], $sql);
            //echo "SQL: ".$sql."<br>";
			setcookie('MYDE_REMENBERME_ID', $ID_sha256,time() + (86400 * 30), "/","queromarita.com.br");
			setcookie('MYDE_REMENBERME_TOKEN', $token_sha256,time() + (86400 * 30), "/","queromarita.com.br");
            //echo "Criei";
			$string = 'redirect';
            //echo $string;
			return $string;
