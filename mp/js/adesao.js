	...
	if(jsonData[i].erro === 1 && jsonData[i].opt === 'Toast'){
        ...
        switch(jsonData[i].funcao){
            ...
            case 'redir_redefacil':
                window.location.href = "https://queromarita.com.br/redefacil_iframe.html?pg="+jsonData[i].msg;
            break;
		}
	}
}
...
function vincular(){
    ...
    setTimeout(function (){
        WindowLogout.close();
        window.location.href = "https://queromarita.com.br/autorizacao.html";
    },3000);
...
function redir_marita(){
    ...
    var url="https://queromarita.com.br/bg_redirect_redefacil.php";
    var parametros = {
        id:id,
    };
