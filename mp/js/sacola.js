            ...
            case "sacola":
                switch(jsonData[i].opt) {
                    ...
                    case "sacola__comprar":
                        //window.location.replace('https://queromarita.com.br/bg_pagamento_transp.php?fn=pagar_distrib');
                        window.location.replace('https://queromarita.com.br/pgto_iframe.html');
                    break;
...
function alterar_qtde(id, valor_unit){
    ...
    var url="https://queromarita.com.br/bg_sacola__atualizar_qtde.php";
...
function remover_produto(id){
    var url="https://queromarita.com.br/bg_sacola__remover.php";
    var parametros = {
        id:id,
        fn:"sacola"
...
function comprar(){
    var url="https://queromarita.com.br/bg_sacola__comprar.php";
    var parametros = {
        1:1
    };
