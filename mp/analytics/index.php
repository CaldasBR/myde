...
if (isset($_SESSION['access_token']) && $_SESSION['access_token']) {
  ...
  $redirect_uri = 'https://' . $_SERVER['HTTP_HOST'] . '/analytics/oauth2callback.php';
...
function getReport($analytics) {
  ...
  $sessions2->setExpression("ga:pagePath");

  $sessions3 = new Google_Service_AnalyticsReporting_Metric();
  $sessions3->setExpression("ga:pageviews");

  //$sessions->setAlias("maximums,");
