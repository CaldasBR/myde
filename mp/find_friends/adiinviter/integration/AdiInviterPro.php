...
/*+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
	...
	**/
	...
	function getLoggedInUserId()
	{
	   ...
	   $userid = 0; //Userid for not logged in user in your website.
...
/*+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
	...
	**/
	...
	function getUserAvatarUrl($userid, $username = '', $email = '', $avatar_value = '')
	{
	   ...
	   {
	      return 'https://queromarita.com.br' . $_SESSION["user_picture"];
	   }
	}
...
/*+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-*/
	...
	*/
	...
	function getProfilePageURL($params = array())
	{
	   ...
	   {
	      return 'https://queromarita.com.br/' . $_SESSION["user_email"];
	   }
	}
