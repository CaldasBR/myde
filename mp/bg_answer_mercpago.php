            ...
            case 'payment':
                ...
                if($pgto['status']== 'approved'){
                    ...
                    if($transaction_amount_payments >= $transaction_amount_order){
                        ...
                        if($pgto['payment_type']=='shipping'){
                            $envio = 'Postar';
                        }else{
                            $envio = 'Combinar';
                        }
                        
                        $dados_comprador = array("order"=>$pgto['order_id'],"nome"=>$tbl_user_comprador[0],"email"=>$tbl_user_comprador[1],"envio"=>$envio);
                        //array("order"=>$pgto['order_id'],"nome"=>$tbl_user_comprador[0],"email"=>$tbl_user_comprador[1]);                        
                        ...
                        $dados_vendedor = array("order"=>$pgto['order_id'],"nome"=>$tbl_user_vendedor[0],"email"=>$tbl_user_vendedor[1],"envio"=>$envio);
                        //array("order"=>$pgto['order_id'],"nome"=>$tbl_user_vendedor[0],"email"=>$tbl_user_vendedor[1]);
