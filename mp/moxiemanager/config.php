<?php
	// General
	$moxieManagerConfig['general.license'] = 'EPHX-PROD-23RJ-SDF9-345K-FSD0-KER4-2I40';
	...
	$moxieManagerConfig['basicauthenticator.users'] = array(
		array("username" => "contato@myde.com.br", "password" => "MOXIEMANAGERqsenha123", "groups" => array("administrator"))
	);
