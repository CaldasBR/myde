<?php
    ...
    if($status_log=="mantem"){
        if(isset($_GET["fn"]) || isset($_POST["fn"])){
            ...
            switch ($fn){
                case 'le_cadastro':
                    $sql = "SELECT id, nome_completo, email, cep, uf, cidade, bairro, end_cobranca, num_imovel, complemento, cel, pg_facebook, txt_apres, cpf, imagem, access_group from tb_usuarios where id = ". $_SESSION['user_id'].";";
