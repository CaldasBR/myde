<?php
        ...
        if(isset($_GET["fn"]) || isset($_POST["fn"])){
            ...
            switch ($fn){
                ...
                case 'criar_assinatura':
                    criar_assinatura('Plano top chat 1m free', 1, 'months', 1, 'months',69.90,'Plano 3, 1m free');
                break;
            }
        }else{
            $erro = 1;
    ...
    function criar_assinatura($descricao, $freq, $freq_type, $freq_free, $freq_type_free,$valor,$reference){
        global $erro,$msg,$opt;
        $header = array(
