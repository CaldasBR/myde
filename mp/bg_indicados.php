<?php
            ...
            for($i=0;$i<mysqli_num_rows($query);$i++){
                ...
                $msg = $msg . '
                    <tr>
                        ...
                        <td>'.$row[2].'</td>
                        <td>'.$row[3].'</td>
                        <td><a href="javascript:void(0);" onclick="reenviar_email(\''.$row[0].'\',\''.$row[1].'\');"><i class="fa fa-refresh fa-lg" aria-hidden="true"></i></a></td>
    ...
    function reenviar_email(){
        ...
        if(isset($_GET["nome"]) && isset($_GET["email"])){
            ...
            $erro = 1;
            $msg = "Houve erro no envio da mensagem.";
            $opt = "Toast";
        }
    }
	...
	$envia_resposta = array("erro"=>$erro,"msg"=>$msg,"funcao"=>$funcao,"opt"=>$opt, "meu_link"=>$_SESSION["user_email"]);
