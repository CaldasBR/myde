                        ...
                        $msg = '
                            <div class="nav-wrapper">
                                ...
                                <ul class="right hide-on-med-and-down">
                                    ...
                                    <li><a href="javascript:void(0);" onclick="window.open(\'https://dashboard.tawk.to/login\');"><i class="material-icons left ">textsms</i>Meu Bate-Papo</a></li>
                                ...
                                <ul class="side-nav collapsible" data-collapsible="accordion" id="nav-mobile">
                                    ...
                                    <li><a class="collapsible-header waves-effect waves-teal active" href="javascript:void(0);" onclick="window.open(\'https://dashboard.tawk.to/login\');"><i class="material-icons left ">textsms</i>Meu Bate-Papo</a></li>
                                    ...
                                    <li>
                                        ...
                                        <div class="collapsible-body" style="display: block;">
                                            <ul>
                                                ...
                                                <li><a href="javascript:void(0);" onclick="window.open(\'https://dashboard.tawk.to/login\');">Meu Bate-Papo</a></li>
