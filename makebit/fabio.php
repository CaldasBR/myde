<?php
    ...
    $api_key_gl = 'hjy8LsmnjOWuF9TRejDrlSvZd8RaObZTTaD0H87r5yM';
    $api_secret_gl = 'ySrM1zHOAqtd9gPjlE64ZC41nIcURvYf5VIdwTB4J4I';
    ...
    switch ($fn){
        ...
        default:
            ...
            */
            ...
            //sleep(1);
            //foxbit_cancelar_ordem($api_key_gl,$api_secret_gl,1459157034153,171212135823);
            //echo "<br><br>";
    ...
    function foxbit_ver_cotacao(){
        ...
        if(mysqli_num_rows($query)>0){
            ...
            echo '
                <form action="fabio.php?fn=update&loss='.$row[0].'&gain='.$row[1].'">
